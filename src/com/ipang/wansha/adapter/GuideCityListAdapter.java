...
public class GuideCityListAdapter extends ArrayAdapter<City> {
	...
	public GuideCityListAdapter(Context context, List<City> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String[] names = Utility.splitChnEng(getItem(position).getCityName());
