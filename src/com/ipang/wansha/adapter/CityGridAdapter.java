...
public class CityGridAdapter extends ArrayAdapter<City> {
	...
	public CityGridAdapter(Context context, List<City> cities, int height) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.cityNameTextView.setText(Utility.splitChnEng(getItem(position).getCityName())[0]);
